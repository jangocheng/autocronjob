...
class PeriodicTaskForm(forms.ModelForm):
    ...
    enabled = forms.BooleanField(
        required=False,
        label=_('Enabled schedule')
    )
    mail_monitor_enabled = forms.BooleanField(
        required=False,
        label=_('Enabled Mail Monitor')
    )
    webhook_monitor_enabled = forms.BooleanField(
        required=False,
        label=_('Enabled Webhook Monitor')
    )
