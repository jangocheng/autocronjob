...
class CrontabSchedule(models.Model):
    ...
    timezone = timezone_field.TimeZoneField(
        ...
        help_text=_(
            'Timezone to Run the Cron Schedule on.  Default is Asia/Shanghai.'),
    )
...
class MailAddress(models.Model):
    ...
    mailname = models.CharField(
        max_length=200, unique=True,
        verbose_name=_('Mail Name'),
        help_text=_('Short Description For This Mail'),
    )
    mailaddress = models.TextField(
        blank=True,
        verbose_name=_('Monitor Mail Address'),
        help_text=_(
            'This is for receiving warning emails'),
    )
...
class WebhookUrl(models.Model):
    ...
    webhookname = models.CharField(
        max_length=200, unique=True,
        verbose_name=_('Webhook Name'),
        help_text=_('Short Description For This Webhook Url'),
    )
    webhookurl = models.URLField(
        max_length=200, unique=True,
        verbose_name=_('Webhook Url Address'),
        help_text=_('This is for receiving warning webhook info'),
    )
...
class PeriodicTask(models.Model):
    ...
    mailaddress = models.ForeignKey(
        MailAddress, on_delete=models.CASCADE, null=True, blank=True,
        verbose_name=_('Mail Monitor Address'),
        help_text=_('Send monitor info to mail address'),
    )
    webhookurl = models.ForeignKey(
        WebhookUrl, on_delete=models.CASCADE, null=True, blank=True,
        verbose_name=_('Webhook Monitor Url'),
        help_text=_('Send monitor info to webhook url'),
    )
    ...
    enabled = models.BooleanField(
        default=True,
        verbose_name=_('Enabled schedule'),
        help_text=_('Set to False to disable the schedule'),
    )
    mail_monitor_enabled = models.BooleanField(
        default=False,
        verbose_name=_('Enabled Mail Monitor'),
        help_text=_('Set to False to disable the send mail'),
    )
    webhook_monitor_enabled = models.BooleanField(
        default=False,
        verbose_name=_('Enabled Webhook Monitor'),
        help_text=_('Set to False to disable the send webhook message'),
    )
